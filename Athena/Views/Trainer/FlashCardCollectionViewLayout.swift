...
class FlashCardCollectionViewLayout: UICollectionViewLayout {
    fileprivate var cache = [UICollectionViewLayoutAttributes]()
    fileprivate var numberOfColumns = 1
    fileprivate var cellPadding: CGFloat = 50
    ...
    override func prepare() {
        ...
        let cellWidth: CGFloat = contentWidth
        let cellHeight: CGFloat = contentWidth * 1.5
